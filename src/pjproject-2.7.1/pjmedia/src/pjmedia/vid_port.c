...
/// ABChernic
PJ_DEF(pj_status_t) pjmedia_vid_port_pass_sdl_window(pjmedia_vid_port *vp, pjmedia_vid_port *vpP)
{
    pj_status_t status = PJ_SUCCESS;
    status = pjmedia_vid_dev_stream_pass_sdl_window(vp->strm, vpP->strm);
    return status;
}
